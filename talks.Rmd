...
Presentation of the {kofdata} R package at the adminR meetup during Statistiktage 2021. {kofdata} is an R layer around the KOF data REST API for data transfer. 
